...
do
    # Variables:
    ids_of_split="/Users/ila/01-Unibo/archive/02_Lab2/files_lab2_project/all_data/trainingset/cv_ids_clean/training/train_${i}"
    ...
    output="/Users/ila/01-Unibo/00_BDP1/BDP-project/large_svm_input/train${i}.svm"
